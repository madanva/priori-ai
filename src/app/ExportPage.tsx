...
export default function ExportPage() {
  ...
  const { patient, draft, setExportStatus, exportStatus } = useStore()
    ...
    >
      <Card className="w-full max-w-md">
        <CardHeader>
          ...
          <CardDescription className="text-center">Your prior authorization letter is ready</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            <div className="p-4 bg-background rounded-md border border-border">
              ...
              <div className="mt-2 space-y-2 text-sm">
                ...
                <p>
                  <span className="font-medium">Request:</span> Epidural Steroid Injection
                </p>
                <p>
